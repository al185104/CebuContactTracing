...
using CebuContactTracing.Exceptions;
using System;
using System.Net;
...
namespace CebuContactTracing.Services.RequestProvider
{
    public class RequestProvider : IRequestProvider
    {
        ...
        public async Task<TResult> GetAsync<TResult>(string uri, string token = "")
        {
            ...
            if (uri.Contains("covid"))
            {
                httpClient = CreateHttpClient();
                httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("X-Authorization", "a3e98003-a1c8-47b9-bcee-b80a4ae891ac");
            }
            else
        ...
        public async Task<TResult> GetAsync<TResult>(string uri, string header, string token = "")
        {
            var httpClient = CreateHttpClient(token);
            if (!string.IsNullOrEmpty(header))
            {
                AddHeaderParameter(httpClient, header, "a3e98003-a1c8-47b9-bcee-b80a4ae891ac");
            }
