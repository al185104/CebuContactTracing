...
namespace CebuContactTracing
{
    public class GlobalSetting
    {
        ...
        //public const string DefaultEndpoint = "https://accessing-data-mysql-1594462994389.azurewebsites.net";
        public const string DefaultEndpoint = "https://trace-api.azurewebsites.net";
        ...
        private string _syncFusionLicense = "MjUxMzQ2QDMxMzgyZTMxMmUzMFNVQ3diL2Z2S0RwWGlrbFVJWlB4ZmNHNEg4cDR1TVp1RGtMMnV4TllxYTA9";

        public string SyncFusionLicense
        {
            get { return _syncFusionLicense; }
            set { _syncFusionLicense = value; }
        }
